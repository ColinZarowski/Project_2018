...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        <h2 class="alignText">Solar Energy</h2>
        ...
        <ul class="identPoints">
            <li><h4>Clean and Renewable</h4></li>
            <li><h4>One of the most cost-effective power source methods. </h4></li>
            <li><h4>DKAL is located in one of the best areas for solar power generation in Canada. (see the diagram below)</h4></li>
        </ul>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/img/solar1.jpg" Height="354px" Width="555px" />
