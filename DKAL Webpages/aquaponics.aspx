    ...
    <form id="form1" runat="server">
		...
		<div class="container">
			<div class="column-center"><strong>Process</strong> </br>
				...
				<p>Water from a fish tank is pumped into a flood tank, where the ammonia-rich waste produced by the fish is properly mixed. This fertiliser serves as a source of nutrients for the plants stacked over the fish tank.
...
The recycling process of aquaponics improves hydroponics self-sufficiency and removes the need for additional resources to aid plant growth.</p>
...
In the process, the plants purify water for the aquatic animals. Aquaculture and hydroponic farming techniques provide the basis for aquaponics systems in terms of complexity, size and the types of foods/plants grown in aquaponics systems.</p>
